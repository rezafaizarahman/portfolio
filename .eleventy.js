...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addShortcode("respimg", (path, alt, style) => {
    ...
    const srcset = eleventyConfig.srcsetWidths
      .map(({ w, v }) => {
        return `${fetchBase}dpr_auto,q_auto,w_${w}/portfolio/${path}.${eleventyConfig.format} ${v}w`;
      })
      .join(", ");
  ...
  eleventyConfig.cloudinaryCloudName = "tenun";
  eleventyConfig.srcsetWidths = [
    { w: 400, v: 400 },
    { w: 600, v: 600 },
    { w: 768, v: 768 },
    { w: 820, v: 820 },
    { w: 1240 * 1.5, v: 1240 * 1.5 },
  ];
